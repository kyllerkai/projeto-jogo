...
import {
	Box, Stack, Link as ChakraLink,
	HTMLChakraProps, useToken, chakra,
	useColorModeValue, ButtonGroup, ButtonGroupProps, IconButton, TextProps, Text
		...
		<Footer>
			...
			<Footer.Row>
				...
				<Footer.Column>
					...
					<Footer.Texto>Recomendações de conteúdo</Footer.Texto>
				</Footer.Column>
			</Footer.Row>
			<Footer.Break />
...
const FooterIcon = (props: HTMLChakraProps<'svg'>) => {
...
const Copyright = (props: TextProps) => (
		<Text fontSize="sm" {...props}>
			&copy; {new Date().getFullYear()} Fã-animation, Inc.
		</Text>
);